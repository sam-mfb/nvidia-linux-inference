...
if [ ! -s "$LOG" ]; then
    echo "timestamp,gpu0_temp,gpu0_power_w,gpu0_mem_mib,gpu0_util_pct,gpu1_temp,gpu1_power_w,gpu1_mem_mib,gpu1_util_pct,cpu_temp,nvme_temp,load1,mem_used_mib,ollama_status" >> "$LOG"
fi
...
echo "${TS},${GPU0_TEMP},${GPU0_POW},${GPU0_MEM},${GPU0_UTIL},${GPU1_TEMP},${GPU1_POW},${GPU1_MEM},${GPU1_UTIL},${CPU_TEMP},${NVME_TEMP},${LOAD1},${MEM_USED},${OLLAMA_STATUS}" >> "$LOG"
